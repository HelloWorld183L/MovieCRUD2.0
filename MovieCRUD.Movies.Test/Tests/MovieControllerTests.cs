...
namespace MovieCRUD.Movies.Tests
{
    public class MovieControllerTests
    {
        ...
        {
            var paginationFilter = new PaginationFilter(pageIndex, pageSize);

            var genreFilter = new GetAllByGenreFilter(genre);
        ...
        {
            var expectedGenreFilter = new GetAllByGenreFilter(genre);
        ...
        public void GetMovies_QueryToFilterMappingSuccessful(int pageIndex, int pageSize)
        {
            ...
            var expectedFilter = new PaginationFilter(pageIndex, pageSize);
        ...
        public void EditMovie_MovieIsEdited(EditMovieRequest editMovieRequest)
        {
            var editedMovie = new Movie()
            {
                ...
                Rating = editMovieRequest.Rating
            };
